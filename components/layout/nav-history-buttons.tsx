...
export function NavHistoryButtons() {
  ...
  const baseStyle: React.CSSProperties = {
    ...
    border: "1.5px solid rgba(34, 181, 227, 0.28)",
  ...
  const onEnter = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    el.style.background = "rgba(34, 181, 227, 0.16)";
    el.style.borderColor = "rgb(var(--vp-cyan))";
    el.style.transform = "translateY(-1px)";
    el.style.boxShadow = "0 4px 12px rgba(34, 181, 227, 0.22)";
  };

  const onLeave = (e: React.MouseEvent<HTMLButtonElement>) => {
    const el = e.currentTarget;
    el.style.background = "var(--vp-cyan-tint)";
    el.style.borderColor = "rgba(34, 181, 227, 0.28)";
    el.style.transform = "";
    el.style.boxShadow = "";
  };
