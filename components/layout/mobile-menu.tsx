    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger asChild>
        <button
          ...
          className="md:hidden inline-flex items-center justify-center size-11 rounded-full border border-hairline bg-white/80 text-ink-strong active:scale-95 transition-transform -ml-1"
          style={{
