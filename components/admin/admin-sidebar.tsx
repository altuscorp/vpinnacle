...
const NAV: ReadonlyArray<NavItem> = [
  ...
  { href: "/admin/health" as Route,      label: "Health",      icon: HeartPulse },
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 50% at 0% 0%, rgba(225, 29, 42, 0.22), transparent 70%), radial-gradient(ellipse 70% 60% at 100% 100%, rgba(168, 85, 247, 0.16), transparent 70%)",
        }}
      />
      ...
      <div className="relative flex flex-col h-full overflow-hidden">
        ...
        <div className="px-6 pt-8 pb-6 shrink-0">
          <div
            className="text-[11px] uppercase font-bold mb-2.5"
            style={{
          ...
          <div className="flex items-baseline gap-2.5 flex-wrap">
            ...
            <span
              ...
              style={{
                ...
                boxShadow: "0 2px 8px rgba(225, 29, 42, 0.35)",
          ...
          <p className="text-[12.5px] mt-2 text-white/60">altuscorp.in</p>
        </div>
                ...
                style={
                  active
                    ? {
                        ...
                        color: "#ffffff",
                        boxShadow:
                          "0 8px 22px -10px rgba(225, 29, 42, 0.55), inset 0 1px 0 rgba(255,255,255,0.14)",
                      }
                    : {
