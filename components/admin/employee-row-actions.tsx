        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed left-1/2 top-1/2 z-[100] -translate-x-1/2 -translate-y-1/2 w-full max-w-md rounded-xl bg-white border border-[#E2E8F0] p-6 shadow-lg max-h-[calc(100dvh-32px)] overflow-y-auto">
            ...
            {deleteImpact === null ? (
              ...
              <div className="rounded-lg border border-red-200 bg-red-50 p-3 text-[13px] text-[#B0141F] mb-4">
            ...
            <label className="block mb-2">
              <span className="block text-[13px] font-semibold text-[#334155] mb-1.5">
                Type <span className="font-mono text-[12.5px] text-[#B0141F]">{employee.email}</span> to confirm
              </span>
              <input
                type="text"
                autoComplete="off"
          ...
          <Dialog.Content className="fixed left-1/2 top-1/2 z-[100] -translate-x-1/2 -translate-y-1/2 w-full max-w-md rounded-xl bg-white border border-[#E2E8F0] p-6 shadow-lg max-h-[calc(100dvh-32px)] overflow-y-auto">
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <button
                ...
                style={
                  confirm === "deactivate"
                    ? { background: "linear-gradient(135deg, #E11D2A, #B0141F)" }
