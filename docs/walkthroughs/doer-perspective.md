# Doer perspective — your day on VPinnacle Dashboard

This walkthrough is for a regular employee at VPinnacle Loans — someone who *does* the work, rather than someone who hands it out. It walks you through every screen you'll touch in a normal week, in the order you'll meet them. Every button name, colour and message below is the exact text the system shows you today, so you can follow along on the live site without guesswork.

---

## A. Your very first sign-in

You don't sign yourself up — your admin (typically the team lead or Manan) creates your account first. The moment they do, you receive an email.

**The email.** Subject line: **"You've been invited to VPinnacle Dashboard"**, from *VPinnacle Dashboard*. The body opens with "Hi *[Your name]*, *[Admin's name]* has invited you to the VPinnacle Dashboard — the work-management tool VPinnacle Loans is using to track tasks across the team." There's a single red button: **"Set password and sign in"**. The link is valid for 24 hours.
...
- **Slack DM** — link your Slack workspace handle; the server resolves it to a `slack_user_id` and DMs land in a channel called *VPinnacle Dashboard*.
