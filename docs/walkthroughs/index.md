# VPinnacle Dashboard — walkthroughs
...
VPinnacle Dashboard is a "Light Vibrant" work-management app for the VPinnacle Loans team. It replaces a single-file HTML dashboard. The current build covers:
