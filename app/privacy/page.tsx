...
export const metadata: Metadata = {
  title: "Privacy Policy · VPinnacle Dashboard",
  description:
    "How the VPinnacle Loans operations dashboard collects, stores, and shares personal data — written for the staff and contractors who use it daily.",
};
...
export default function PrivacyPage() {
  return (
    <LegalShell
      ...
      intro="This policy explains what personal data flows through the VPinnacle Loans dashboard, why it's collected, where it sits, and what controls you have. Written plainly so you can read it once and trust what's happening behind the chrome."
    >
      ...
      <p>
        <strong>Data controller:</strong> VPinnacle Loans &amp; Project Advisors
        Pvt. Ltd. — the operational data (tasks, comments, assignments,
        statuses) is theirs.
      </p>
      <p>
        <strong>Data processor:</strong> Altus Corp builds and operates the
        dashboard on VPinnacle Loans' behalf. We do not use your data for any
        purpose other than running the dashboard.
      </p>
      ...
      <ul>
        ...
        <li><strong>To audit who did what, when.</strong> Every task event is logged for VPinnacle Loans' internal compliance.</li>
      ...
      <ul>
        ...
        <li>We don't share your information with other VPinnacle Loans customers, brokers, or borrowers.</li>
        <li>We don't profile you for marketing.</li>
        <li>We don't combine the dashboard's data with data from other Altus Corp engagements.</li>
      </ul>
      ...
      <p>
        ...
        remain accurate — VPinnacle Loans' audit needs require this. Hard
        deletion is not exposed in the dashboard; if you want a row purged,
        that becomes a manual ops runbook between Altus Corp and VPinnacle
        Loans' legal point of contact.
      </p>
      <p>
      ...
      <ul>
        <li>
          <strong>The right to know.</strong> Ask your VPinnacle administrator
          for a copy of the data the dashboard holds about you. We support CSV
          exports on the employees + tasks tables out of the box.
        </li>
        <li>
      ...
      <p>
        ...
        <a href="mailto:manan@altuscorp.in">manan@altuscorp.in</a> before
        disclosing it publicly. We will reply within 72 hours.
      </p>
      ...
      <p>
        Privacy questions:{" "}
        <a href="mailto:manan@altuscorp.in">manan@altuscorp.in</a>. Operational
        data requests (export your row, deactivate your account, correct a
        record): your VPinnacle Loans administrator — currently Pravinkumar
        Joshi (<a href="mailto:pravin@vpinnacle.com">pravin@vpinnacle.com</a>).
      </p>
    </LegalShell>
  );
}
